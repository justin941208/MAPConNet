...
class ElaINGenerator(BaseNetwork):
    ...
    def __init__(self, opt):
        ...
        self.elain_block1 = ElaINResnetBlock(16 * nf, 16 * nf, self.id_dim)
        self.elain_block2 = ElaINResnetBlock(8 * nf, 8 * nf, self.id_dim)
        self.elain_block3 = ElaINResnetBlock(4 * nf, 4 * nf, self.id_dim)


    def forward(self, identity_features, warp_out):
        x = warp_out.transpose(2,1)
        addition = identity_features[:, :self.id_dim, :]
